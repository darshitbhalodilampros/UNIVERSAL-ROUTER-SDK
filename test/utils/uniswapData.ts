...
import { MixedRouteTrade, MixedRouteSDK, Trade as RouterTrade } from 'lampros-router'
...
import { CurrencyAmount, TradeType, Ether, Token, Percent, Currency } from 'lampros-core'
